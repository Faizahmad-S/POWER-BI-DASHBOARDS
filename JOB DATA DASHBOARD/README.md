...
To solve this for myself (and others like me), I built a dashboard using a dataset of 2024 data science job postings provided by **Luke Barousse** in his [Powerbi-Course](https://www.youtube.com/watch?v=FwjaHCVNBWA&t=15047s). It brings important details such as job titles, salaries, and locations into a single place so anyone exploring a data career can quickly understand the market.
...
I practiced shaping raw data by fixing blanks, correcting data types, and creating new useful columns.

- **🧮 Creating Basic Quick Measures:**
Learned to build Quick measures like **star ratings** to support meaningful insights.

- **📊 Visualizations:**
Used basic chart types : **Column, Bar, Line,** and **Area charts**-to compare trends and job counts.

- **🗺️ Mapping Skills:**
Added a **Map visual** to show global job locations, which was a great introduction to geo-spatial analysis.

- **🔢 Cards & Tables:**
Used **cards** for quick insights and **tables** for detailed job information.

- **🎨 Dashboard Layout & Design:**
Explored different layouts, color schemes, and chart combinations to make the dashboard clean and easy to use.

- **🖱️ Interactivity:**
Practiced key Power BI interactive features:

    - **Slicers** for filtering job titles

    - **Buttons & Bookmarks** for smooth navigation

    - **Drill-Through** to move from a summary view to detailed insights
